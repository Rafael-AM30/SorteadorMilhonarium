...
else if (status1)
{
    ...
    numerosP1[0] = int.Parse(Console.ReadLine());
    numerosP1[1] = int.Parse(Console.ReadLine());
    numerosP1[2] = int.Parse(Console.ReadLine());
}
Console.Clear();
...
else if (status2)
{
    ...
    numerosP2[0] = int.Parse(Console.ReadLine());
    numerosP2[1] = int.Parse(Console.ReadLine());
    numerosP2[2] = int.Parse(Console.ReadLine());
}
Console.Clear();
...
else if (status3)
{
    ...
    numerosP3[0] = int.Parse(Console.ReadLine());
    numerosP3[1] = int.Parse(Console.ReadLine());
    numerosP3[2] = int.Parse(Console.ReadLine());
}
Console.Clear();
...
else if (status4)
{
    ...
    numerosP4[0] = int.Parse(Console.ReadLine());
    numerosP4[1] = int.Parse(Console.ReadLine());
    numerosP4[2] = int.Parse(Console.ReadLine());
}
Console.Clear();
...
else if (status5)
{
    ...
    numerosP5[0] = int.Parse(Console.ReadLine());
    numerosP5[1] = int.Parse(Console.ReadLine());
    numerosP5[2] = int.Parse(Console.ReadLine());
}
Console.Clear();
    ...
    case >1:
        {
           int valorDoPremioDividido = valorDoPremio / numDeVencedores;
            ...
            if (par)
            {
                ...
                if (numerosP1.Contains(numeroSorteado))
                    Console.WriteLine($" {nome1} com {idade1} anos de idade recebera = {valorDoPremioDividido + bonusPar + (bonus100 * idade1).ToString("R$ 000,000.00")} \n");
                
                if (numerosP1.Contains(numeroSorteado))
                    Console.WriteLine($" {nome2} com {idade2} anos de idade recebera = {valorDoPremioDividido + bonusPar + (bonus100 * idade1).ToString("R$ 000,000.00")} \n");
               
                if (numerosP1.Contains(numeroSorteado))
                    Console.WriteLine($" {nome3} com {idade3} anos de idade recebera = {valorDoPremioDividido + bonusPar + (bonus100 * idade1).ToString("R$ 000,000.00")} \n");
               
                if (numerosP1.Contains(numeroSorteado))
                    Console.WriteLine($" {nome4} com {idade4} anos de idade recebera = {valorDoPremioDividido + bonusPar + (bonus100 * idade1).ToString("R$ 000,000.00")} \n");
                
                if (numerosP1.Contains(numeroSorteado))
                Console.WriteLine($" {nome5} com {idade5} anos de idade recebera = {valorDoPremioDividido + bonusPar + (bonus100 * idade1).ToString("R$ 000,000.00")} \n");
            ...
            {
                if (numerosP1.Contains(numeroSorteado))                                
                    Console.WriteLine($" {nome1} com {idade1} anos de idade recebera: {valorDoPremioDividido + (bonus100 * idade1).ToString("R$ 000,000.00")}");

                if (numerosP2.Contains(numeroSorteado))
                    Console.WriteLine($" {nome2} com {idade2} anos de idade recebera: {valorDoPremioDividido + (bonus100 * idade2).ToString("R$ 000,000.00")}");

                if (numerosP3.Contains(numeroSorteado))
                    Console.WriteLine($" {nome3} com {idade3} anos de idade recebera: {valorDoPremioDividido + (bonus100 * idade3).ToString("R$ 000,000.00")}");

                if (numerosP4.Contains(numeroSorteado))
                    Console.WriteLine($" {nome4} com {idade4} anos de idade recebera: {valorDoPremioDividido + (bonus100 * idade4).ToString("R$ 000,000.00")}");

                if (numerosP5.Contains(numeroSorteado))
                    Console.WriteLine($" {nome5} com {idade5} anos de idade recebera: {valorDoPremioDividido + (bonus100 * idade5).ToString("R$ 000,000.00")}");
    ...
    case 1:
        {
            ...
            else if (numeroSorteado == 7)
            {
                ...
                if (numerosP1.Contains(numeroSorteado))
                    Console.WriteLine($" O(a) grande Vencedor(a) Foi {nome1} com {idade1} anos de Idade\n" +
                                      $" {nome1} recebera: {totalBonus7.ToString("R$ 0,000,000.00")} \n");
                if (numerosP2.Contains(numeroSorteado))
                    Console.WriteLine($" O(a) grande Vencedor(a) Foi {nome2} com {idade2} anos de Idade\n" +
                                      $" {nome2} recebera: {totalBonus7.ToString("R$ 0,,000,000.00")} \n");
                if (numerosP3.Contains(numeroSorteado))
                    Console.WriteLine($" O(a) grande Vencedor(a) Foi {nome3} com {idade3} anos de Idade\n" +
                                      $" {nome3} recebera: {totalBonus7.ToString("R$ 0,000,000.00")} \n");
                if (numerosP4.Contains(numeroSorteado))
                    Console.WriteLine($" O(a) grande Vencedor(a) Foi {nome4} com {idade4} anos de Idade\n" +
                                      $" {nome4} recebera: {totalBonus7.ToString("R$ 0,000,000.00")} \n");
                if (numerosP5.Contains(numeroSorteado))
                    Console.WriteLine($" O(a) grande Vencedor(a) Foi {nome5} com {idade5} anos de Idade\n" +
                                      $" {nome5} recebera: {totalBonus7.ToString("R$ 0,000,000.00")} \n");
